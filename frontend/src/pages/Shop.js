      ...
      >
        <div className="h-[185px] bg-[#0b1220] flex items-center justify-center overflow-hidden">
          {image ? (
            <img
              src={image}
              alt={product.title || t("shop_untitled_product")}
              className="w-full h-full object-contain p-4 hover:scale-105 transition-transform duration-300"
            />
          ) : (
            <div className="text-gray-500 text-sm">
        ...
        <div className="p-4 flex flex-col flex-1 text-right">
          <h3 className="text-white font-bold leading-7 line-clamp-2 min-h-[56px]">
            {product.title || t("shop_untitled_product")}
          </h3>

          <div className="mt-auto pt-4">
            {product.brand && (
              <div className="text-gray-500 text-xs mb-2">
                {t("shop_brand_label")}: {product.brand}
              </div>
            )}

            {price ? (
              <div className="text-yellow-400 font-extrabold">
                {price} {t("shop_currency")}
              </div>
            ) : (
              <div className="text-gray-400 text-sm">
                {t("shop_price_inquiry")}
              </div>
            )}
...
function AdsSidebar({ ads }) {
  ...
  const FALLBACK_ADS = [
    { id: "vip", title: t("shop_ad_vip"), image: "/videos/hero.gif" },
    { id: "eco", title: t("shop_ad_eco"), image: "/videos/hero.gif" },
    { id: "popular", title: t("shop_ad_popular"), image: "/videos/hero.gif" },
  ];
        ...
        <div className="flex justify-center gap-2 mt-6">
          {groups.map((_, index) => (
            <button
              ...
              type="button"
              onClick={() => setActive(index)}
              aria-label={`${t("shop_slider_aria")} ${index + 1}`}
              className={`
                h-2.5
                rounded-full
                transition-all
...
function LiveChat() {
  ...
  const sendMessage = async () => {
    ...
    if (!cleanName) {
      alert(t("shop_chat_name_required"));
      return;
    }
              ...
              <div className="border-t border-gray-800 p-4">
                <div className="grid grid-cols-1 md:grid-cols-[180px_1fr_auto] gap-3">
                  <input
                    ...
                    placeholder={t("shop_chat_name_placeholder")}
                    className="
                      bg-black
                      border border-gray-800
                      rounded-xl
                  ...
                  <input
                    ...
                    placeholder={t("shop_chat_message_placeholder")}
                    className="
                      bg-black
                      border border-gray-800
                      rounded-xl
...
function TrustSignals() {
  ...
  const items = [
    { icon: <FaShieldAlt />, title: t("shop_trust_1") },
    { icon: <FaCertificate />, title: t("shop_trust_2") },
    { icon: <FaHandshake />, title: t("shop_trust_3") },
    { icon: <FaAward />, title: t("shop_trust_4") },
  ];
...
export default function Shop() {
  ...
  const activeCategoryName = useMemo(() => {
    ...
    return found?.name || t("shop_category");
            ...
            <section className="grid grid-cols-12 gap-7 items-start">
              ...
              <div className="col-span-12 lg:col-span-7 order-2">
                <div className="text-center mb-7">
                  ...
                  <p className="text-gray-500 mt-2">
                    {products.length} {t("shop_products_suffix")}
                  </p>
                </div>
