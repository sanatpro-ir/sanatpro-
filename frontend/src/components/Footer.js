  ...
  return (
    <footer className="relative bg-[#0b0f14] text-gray-300 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-4 md:grid-cols-2 gap-12">
        ...
        <div>
          <h2 className="text-3xl font-extrabold text-white mb-4 whitespace-nowrap">
            PRO<span className="text-[#ffc000]">SANAT</span>
          </h2>
          <p className="text-gray-400 leading-relaxed">
            {t("footer_desc")}
          </p>
          ...
          <div className="flex gap-4 mt-6">
            <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-xl bg-gray-800 hover:bg-[#ffc000] hover:text-black transition">
              <FaLinkedin />
            </a>
            <a href="https://wa.me/989302850915" target="_blank" rel="noopener noreferrer" className="p-3 rounded-xl bg-gray-800 hover:bg-[#25D366] transition">
              <FaWhatsapp />
            </a>
            <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-xl bg-gray-800 hover:bg-[#E1306C] transition">
              <FaInstagram />
            </a>
            <a href="https://www.youtube.com/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-xl bg-gray-800 hover:bg-[#FF0000] transition">
              <FaYoutube />
            </a>
            <a href="https://www.aparat.com/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-xl bg-gray-800 hover:bg-[#FF5A00] transition">
              <SiAparat />
            </a>
          </div>
        </div>
        ...
        <div>
          <h3 className="text-white font-bold mb-6">{t("footer_quick_links")}</h3>
          <ul className="space-y-3">
            <li><a href="/" className="hover:text-[#ffc000] transition">{t("footer_link_home")}</a></li>
            <li><a href="/shop" className="hover:text-[#ffc000] transition">{t("footer_link_shop")}</a></li>
            <li><a href="/inquiry" className="hover:text-[#ffc000] transition">{t("footer_link_inquiry")}</a></li>
            <li><a href="/about" className="hover:text-[#ffc000] transition">{t("footer_link_about")}</a></li>
          </ul>
        </div>

        <div>
          <h3 className="text-white font-bold mb-6">{t("footer_contact_title")}</h3>
          <ul className="space-y-4 text-gray-400">
            <li className="flex gap-3 items-center">
              <FaPhone className="text-[#ffc000]" />
              <span dir="ltr">09302850915</span>
            </li>
            <li className="flex gap-3 items-center">
              <FaEnvelope className="text-[#ffc000]" />
              <span>info@sanatpro.ir</span>
